          ...
          <AreaChart data={chartData} margin={{ top: 5, right: 5, left: 5, bottom: 5 }}>
            <defs>
              <linearGradient id="portfolioGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={isPositive ? '#12805F' : '#B0263B'} stopOpacity={0.25} />
                <stop offset="95%" stopColor={isPositive ? '#12805F' : '#B0263B'} stopOpacity={0} />
              </linearGradient>
            </defs>
            ...
            <Area type="monotone" dataKey="value" stroke={isPositive ? '#12805F' : '#B0263B'} strokeWidth={2} fill="url(#portfolioGrad)" />
          </AreaChart>
        </ResponsiveContainer>
      ) : (
